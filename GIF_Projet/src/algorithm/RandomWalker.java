...
public class RandomWalker implements AlgorithmService, RequireEngineService{
  ...
  public void activation(){
    engine.setChildCommand(User.COMMAND.NONE);
  }
  ...
  public void stepAction(){
    switch (gen.nextInt(4)){
      case 0:
        engine.setChildCommand(User.COMMAND.LEFT);
        break;
      case 1:
        engine.setChildCommand(User.COMMAND.RIGHT);
        break;
      case 2:
        engine.setChildCommand(User.COMMAND.UP);
        break;
      default:
        engine.setChildCommand(User.COMMAND.DOWN);
        break;
    }
  }
}
